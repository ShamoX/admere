...
(* OASIS_START *)
(* DO NOT EDIT (digest: 338316b6882f6f24f75d075d4164b3c4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Roland Laur\195\168s"];
          homepage = None;
          bugreports = None;
          synopsis =
            "Ocaml implementation for a library allowing multidimensional\nadaptive mesh refinement";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_version = "0.4.8";
     oasis_digest =
       Some "\159\222J\167\203\007\t_\154\240\209\020@\174\218\218";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
